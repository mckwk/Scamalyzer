...
DATA_FOLDER_MESSAGES = os.getenv("DATA_FOLDER_MESSAGES", "default/messages/path")
...
BILSTM_MODEL_PATH = os.getenv("BILSTM_MODEL_PATH", "models/output/bilstm_model.h5")
BILSTM_TOKENIZER_PATH = os.getenv("BILSTM_TOKENIZER_PATH", "models/output/bilstm_tokenizer.json")
XGBOOST_MODEL_PATH = os.getenv("XGBOOST_MODEL_PATH", "models/output/xgb_model.joblib")
